...
public class JquryTest {
    public static void main(String[] args) {
        ...
        /***
         *
         * After reading and memorizing you can remove the unnecessary spaces I left. Scroll down and you'll see more
         * Comments.
         *
         *
         * 1. You need to create a directory/folder in your project. Not in your C or D drive.
         * 2. You need to memorize below code. With this code it does not matter in whose machine this code runs.
         * The System.getProperty("user.dir") will always find the root directory, all you need to do is to
         * give the folder name you created and the file it contains.
         * 3. I beleive you created many test cases, However in this class you put everything under the main method.
         * Each test case should be a separate method using testNG annotations, and executed not using main class
         * but using testNG. Check the very bottom of this class to see the examples and update your project.
         *
         */

        // If your company uses Windows use below line
        System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "//drivers//chromedriver.exe");

        //If your company uses Mac use below line
